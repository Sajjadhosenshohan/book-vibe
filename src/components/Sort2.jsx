    ...
    return (
        <div className="card card-side bg-base-100 shadow-xl p-6 gap-6 rounded-2xl border-2 border-[#13131326]">
            ...
            <div className="card-body">
                <h2 className="font-bold text-2xl text-[#131313]">The Catcher in the Rye</h2>
                <p className="text-[#131313CC] font-medium">By: <span>shohan</span></p>
                ...
                <div className="flex  mb-4 gap-4 items-center">
                    ...
                    <div className="flex gap-2 font-bold items-center text-[#131313CC]">
                        ...
                        <p className=" ">Year of Publishing: <span></span></p>
                    </div>
                </div>
                ...
                <div className="flex gap-3">
                    <span className=" py-3 px-5 text-[#328EFF] bg-[#328EFF26] rounded-[30px] ">Category: Classic</span>

                    <span className=" py-3 px-5 text-[#FFAC33] bg-[#328EFF26] rounded-[30px] ">Rating: 4.5</span>
